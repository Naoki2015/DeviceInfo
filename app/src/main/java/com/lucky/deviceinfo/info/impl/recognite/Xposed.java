...
public class Xposed {
    ...
    public String isXposed(Context context) {
        try {
            if (checkPackage(context).equals("0") && checkProc().equals("0") && checkStack().equals("0")) {
                return "0";
            } else {
                return "1";
            }
    ...
    public String xposedTags(Context context) {
        try {
            return checkPackage(context) + checkProc() + checkStack();
        } catch (Throwable e) {
